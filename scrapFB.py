...
def processFacebookPageFeedS(status, access_token):
...
def scrapeFacebookPageFeedS(group_id, access_token):
    with open('%s_facebook_statuses.csv' % group_id, 'wb') as file:
        ...
        while has_next_page:
            for status in statuses['data']:
                w.writerow(processFacebookPageFeedS(status, access_token))
...
if __name__ == '__main__':
    scrapeFacebookPageFeedS(group_id, access_token)
